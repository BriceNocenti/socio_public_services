...
meta <- extract_survey_metadata(df, 
  missing_num = c(96, 99, 996, 999, 9996, 9999), 
  missing_chr = c("Non enquêté", "N'a pas répondu", "Valeur manquante"),
  # missing_num, missing_chr, yes_labels, no_labels, max_levels_cat, detected_roles, positive_levels
)

export_metadata_excel(meta) # "metadata_review.xlsx"
