...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_dir = "~github/socio_public_services") })
output: 
  rmdformats::downcute:
    df_print: kable
    code_folding: hide
...
[Revenir à la liste des articles.](https://github.com/BriceNocenti/socio_public_services/blob/main/index.html)
...
# ggsave2(acm_orga_1_cah_output, dir = "2024_OrgaTravailAdminPub", name = "1-ACM orga cah color",
...
# ggsave2(acm_orga_1_output, dir = "2024_OrgaTravailAdminPub", name = "Graph1-ACM orga base",
#         width = 17, height = 17 / heigth_width_ratio, replace = TRUE, open = TRUE)
```
...
#        path = "2024_OrgaTravailAdminPub", filename = "Graph3-Evolutions organisations.png", device = "png",
